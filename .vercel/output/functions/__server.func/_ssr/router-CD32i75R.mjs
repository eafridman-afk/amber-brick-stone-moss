...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "MoleculoSphere 5D · Beta v1.0 — classical continuum electrostatics (Yukawa / Debye–Hückel). Educational / hypothesis-generation tool. No biological claim without independent validation."
			},
			{ title: APP_NAME },
			...[]
		],
