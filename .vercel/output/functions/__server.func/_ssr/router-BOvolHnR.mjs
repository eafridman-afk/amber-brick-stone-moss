...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BOvolHnR.js
...
var styles_default = "/assets/styles-WbyKPqTr.css";
var APP_NAME = "MoleculoSphere 5D";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Hierarchical multi-scale electrostatic dynamics of highly charged (+3) small molecules under pH regimes relevant to protein behavior."
			},
			{ title: APP_NAME },
			...[]
		],
...
var $$splitComponentImporter = () => import("./routes-C0ZLRBFN.mjs");
